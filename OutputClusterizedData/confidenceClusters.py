...
def generate_tables(data_filename):
#assume that the format is I-I, I-bII I-II, I-bIII ... I-VII, II-I, II-bII ... VII-VII 
	...
	disDict = load_csv(data_filename)
        output_filename = str("tableFor-" + data_filename)
...
#			data = data[chunk*730: (chunk+1)*730]	
	...
	write_csv(meanTable,"meanTransistionProbabilities" + str(output_filename))
        write_csv(intervalTable, "ConfidenceIntervalTransitionalProbabilities" + str(output_filename))
...
# collect list of CSV files in folder for processing
...
for cluster in roster():
    generate_tables(cluster)
